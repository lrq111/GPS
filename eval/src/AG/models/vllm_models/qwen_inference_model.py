...
class VLLMInferenceModel():
    ...
    def __init__(
        ...
        self.tokenizer = AutoTokenizer.from_pretrained(
            pretrained_model_name_or_path=download_dir,
    ...
    def batch_prompt(self, 
        ...
        for prompt in prompts:
            message = [{"role": "system", "content": "You are Qwen, created by Alibaba Cloud. You are a helpful assistant."},{"role": "user", "content": f"{prompt}"}]
            formatted_prompt = self.tokenizer.apply_chat_template(message, tokenize=False, add_generation_prompt=True)
