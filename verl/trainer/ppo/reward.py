...
def compute_reward(config, data: DataProto, reward_fn: AbstractRewardManager) -> tuple[torch.Tensor, dict[str, Any]]:
    """
    ...
    """
    try:
        reward_result = reward_fn(config, data, return_dict=True)
